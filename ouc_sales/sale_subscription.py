...
#        all_lines = self.c_sales_order_id.order_line
    ...
    def activate_all_packages(self):
        if self.c_auto_create_fptag:
            if self.c_sales_order_id.is_corporate_website:
                act_id = "Corporate MLC Case" #self.activate_website_mlc()
        ...
        if self.c_sales_order_id.claim_id:
            line_ids = self.env['sale.subscription.line'].search([('c_sale_order_id', '=', self.c_sales_order_id.id)])
            line_ids.write({'c_activation_id': 'Activated From Manage'})
            return True
    ...
    def assign_member_to_fp_manually(self, fptag, emp_cfc):
        ...
        bccEmails = 'verification@nowfloats.com;mohit.katiyar@nowfloats.com;nitin@nowfloats.com;rajeev.goyal@nowfloats.com;rajat.anand@nowfloats.com;ramesh.masagalla@nowfloats.com'
